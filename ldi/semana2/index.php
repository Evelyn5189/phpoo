<?php
//require pega as informações de outro arquivo php
require ("Carro.php");
...
class Fruta{
    ...
    /*Métodos */
//esse método construtor diz que assim que criamos a nossa classe, ela DEVE ter nome e cor, é tipo isso
...
//new cria um objeto para aquela classe, uma instância
...
?>
<!-- 
Pesquisar acerca de new e set - a diferença entre os dois -->